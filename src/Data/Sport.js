const articles = [
  ...
  },
  {
    ...
    <div className="uni-paragraph">
    <div className="rich-text">
    <p>Starting today, Android Pay is now available in the UK, one of the most advanced contactless
    nations in the world. Android Pay helps people pay for things simply and securely with their
    Android smartphones. This builds on the launch of Android
    Pay in the <a
    href="http://officialandroid.blogspot.co.uk/2015/09/tap-pay-done.html">US</a> last year,
    with new countries coming soon.</p>
    ...
    <div className="uni-paragraph">
    <div className="rich-text">
    <p><b>So, where does Android Pay work in the UK?</b></p>
    <p>You will be able to use Android Pay everywhere contactless payments are accepted including
    your favourite high street stores like Boots, Starbucks and Waitrose and pay for the Tube,
    bus and train with&nbsp;<a
    href="https://www.youtube.com/watch?v=OkzGPV0aoV4&amp;feature=youtu.be">Transport for
    London</a>.
    Just tap with your phone as you would with your card. It’s that simple. And businesses
    across the country with contactless terminals won’t need to do anything else to be able to
    accept Android Pay in store.</p>
    <p>Android Pay will also speed up checkout in your favourite apps including JD Sports,
    Deliveroo, YPlan, and&nbsp;<a href="https://www.android.com/intl/en_uk/pay/#inapps">many
    more</a>.<br/></p>
    <p>Also, we will be launching Android Pay Day, bringing special offers each month to brighten
    the last week before pay day. Starbucks UK and Deliveroo will be among the first to reward
    Android Pay users in the UK. Stay tuned for more offers which
    will roll out in the months to come.</p>
    To start using Android Pay you’ll need to <a
    href="https://pay.app.goo.gl/?link=https://www.android.com/payapp&amp;apn=com.google.android.apps.walletnfcrel&amp;amv=930000000&amp;utm_source=android&amp;utm_medium=blog&amp;utm_campaign=launch">download
    the Android Pay app on Google Play</a> and have an eligible MasterCard or Visa credit or debit
    card from one of our supported banks, such as Bank of Scotland, First Direct, Halifax, HSBC,
    Lloyds Bank, M&amp;S Bank, MBNA and Nationwide Building Society, with new banks being added
    all the time.<br/>
    ...
    <div className="uni-full-width">
    <figure>


    <source media="(max-width: 540px) and (max-resolution: 1.5dppx)" sizes="540px"
    srcSet="https://storage.googleapis.com/gweb-uniblog-publish-prod/images/UKAndroidPayNow.width-540.jpg 540w"/>

    <source media="(max-width: 540px) and (min-resolution: 1.5dppx)" sizes="800px"
    srcSet="https://storage.googleapis.com/gweb-uniblog-publish-prod/images/UKAndroidPayNow.width-800.jpg 800w"/>

    <source media="(max-resolution: 1.5dppx)" sizes="800px"
    srcSet="https://storage.googleapis.com/gweb-uniblog-publish-prod/images/UKAndroidPayNow.width-800.jpg 800w"/>


    <img
    src="https://storage.googleapis.com/gweb-uniblog-publish-prod/images/UKAndroidPayNow.width-800.jpg"
    alt="UKAndroidPayNow.jpg"
    sizes="(max-width: 540px) 540px, (max-width: 540px) 800px,  800px"
    srcSet="https://storage.googleapis.com/gweb-uniblog-publish-prod/images/UKAndroidPayNow.width-540.jpg 540w, https://storage.googleapis.com/gweb-uniblog-publish-prod/images/UKAndroidPayNow.width-800.jpg 800w, https://storage.googleapis.com/gweb-uniblog-publish-prod/images/UKAndroidPayNow.width-800.jpg 800w" />
    ...
    <div className="uni-paragraph">
    <div className="rich-text">Security is at the centre of Android Pay. With industry standard
    tokenisation, Android Pay doesn’t send merchants your real card number when you purchase.
    Android Pay also makes it convenient to keep track of payments and to lock your device if
    it becomes lost or stolen. <br/>
    <br/>
    <p><b>
    What’s next? </b></p>

    Android Pay will soon be available in Singapore and Australia. And we will continue to
    add more countries, features, banks and stores in the coming months—making it even
    easier to pay with your Android phone around the globe.<br/>
    <br/> Get started with Android Pay in the UK today: <a
    href="https://pay.app.goo.gl/?link=https://www.android.com/payapp&amp;apn=com.google.android.apps.walletnfcrel&amp;amv=930000000&amp;utm_source=android&amp;utm_medium=blog&amp;utm_campaign=launch">download
    the app on Google Play</a>,
    add your card and start shopping. It’s as easy as Tap. Pay. Done.<br/></div>
    </div>
